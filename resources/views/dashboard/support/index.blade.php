...
@section('page-subtitle', 'Get help with your account and releases')
...
<div class="space-y-6">
    ...
    <div class="bg-gray-900 rounded-2xl border border-white/5 overflow-hidden">
        <div class="p-4 border-b border-white/5 flex items-center justify-between">
            <h3 class="font-semibold text-white">My Tickets</h3>
        ...
        <div class="p-12 text-center">
            ...
            <a href="{{ route('dashboard.support.create') }}" class="text-purple-400 hover:text-purple-300 text-sm mt-2 inline-block">Create your first ticket →</a>
        </div>
        @else
        <div class="divide-y divide-white/5">
            ...
            <a href="{{ route('dashboard.support.show', $ticket->id) }}" class="flex items-start p-4 hover:bg-white/2 transition group">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-500 text-xs mt-1">{{ $ticket->replies_count ?? 0 }} replies · {{ $ticket->created_at->diffForHumans() }}</p>
                </div>
