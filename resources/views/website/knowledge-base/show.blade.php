...
<section class="pt-32 pb-24 px-4">
    <div class="max-w-3xl mx-auto">
        ...
        <p class="text-gray-400 text-sm mb-8">Last updated {{ $article->updated_at->format('M d, Y') }}</p>
        ...
        <div class="mt-10 glass rounded-2xl p-6 border border-white/5 text-center">
            <p class="text-white font-medium mb-3">Was this article helpful?</p>
            <div class="flex justify-center gap-4">
                <button class="px-5 py-2 bg-green-600/20 hover:bg-green-600/30 text-green-300 text-sm rounded-xl border border-green-500/20 transition">👍 Yes</button>
        ...
        <div class="mt-10">
            <h3 class="text-white font-semibold mb-4">Related Articles</h3>
            <div class="space-y-2">
