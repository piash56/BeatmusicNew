                ...
                <tr class="hover:bg-white/2 transition">
                    <td class="px-4 py-3">
                        <div class="flex items-center space-x-3">
                            @if($track->cover_art)
                                <img src="{{ $track->cover_art_url }}" alt="" loading="lazy" class="w-9 h-9 rounded-lg object-cover flex-shrink-0">
                            @else
                                <div class="w-9 h-9 bg-purple-600/20 rounded-lg flex items-center justify-center flex-shrink-0">
                            ...
                            @endif
                            <p class="text-white font-medium truncate max-w-[150px]">{{ $track->title }}</p>
                        </div>
                    </td>
                    <td class="px-4 py-3 text-gray-300 hidden sm:table-cell">{{ $track->user->full_name ?? 'Unknown' }}</td>
                    <td class="px-4 py-3 text-gray-400 hidden md:table-cell text-xs">{{ $track->user->email ?? '—' }}</td>
                    <td class="px-4 py-3 text-gray-400 hidden md:table-cell">{{ $track->primary_genre }}</td>
                    <td class="px-4 py-3">
                    ...
                    <td class="px-4 py-3 text-right">
                        ...
                        <a href="{{ route('admin.track-submissions.view', $track->id) }}" class="p-1.5 text-gray-400 hover:text-white hover:bg-white/10 rounded-lg transition inline-flex" title="View">
