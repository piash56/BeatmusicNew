...
<div style="max-width: 480px; margin: 0 auto; background: #111827; border-radius: 16px; overflow: hidden;">
    ...
    <div style="padding: 32px;">
        ...
        <p style="color: #9ca3af; line-height: 1.6; margin: 0 0 24px;">Your <strong style="color: #a78bfa;">{{ $user->subscription }}</strong> subscription has been activated. You now have full access to all features.</p>
        <div style="text-align: center; margin: 0 0 24px;">
            <a href="{{ url('/dashboard') }}" style="display: inline-block; background: linear-gradient(135deg, #7c3aed, #4f46e5); color: white; text-decoration: none; padding: 14px 32px; border-radius: 10px; font-weight: bold;">Go to Dashboard</a>
        </div>
    </div>
